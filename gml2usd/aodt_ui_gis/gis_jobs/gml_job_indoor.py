...
class GmlJob:
    ...
    def run(self):
        ...
        # create gml job command string
        cmd_str = utils.make_aodt_gis_indoor_command_str(self)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-cm", "--cm", type=str)
    parser.add_argument("-disable-int", "--disable_interiors", type=bool)
    parser.add_argument("-rough", "--rough", type=bool)
